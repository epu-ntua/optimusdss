...
public class GMEDailyPrices extends DailyPrices {
	String resource 	= ConfigurationManager.getConfiguration().getValue("resourceurl");
	String sensor 		= ConfigurationManager.getConfiguration().getValue("sensor_electricityprices");
	String city 			= ConfigurationManager.getConfiguration().getValue("pilot2_city");
  ...
  public String createRDF() {
		...
		String hhmmss = String.format("%02d:00:00", getHour()-1);		
		...
		String data = "<http://www.optimus-smartcity.eu/resource/test/observation/"+resource+"_"+stDate+">"+
    	  ...
    	  "<http://www.optimus-smartcity.eu/resource/test/instant/"+resource+"_"+stTimeStamp+"> <http://www.w3.org/2006/time#inXSDDateTime> \"2014-08-25T00:00:00+00:00 \"" +"<http://www.w3.org/2001/XMLSchema#dateTime>.";
		*/
		return data;
  }
