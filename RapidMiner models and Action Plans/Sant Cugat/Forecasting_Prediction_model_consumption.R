...
#data=data.frame(read.table("C:/Users/vangelis spil/Google Drive/OPTIMUS/Final Models/SantCougat Prediction Models/Energy Consumption Sant Cougat Town Hall/Inputs/santcugat_energy_out.csv", header = TRUE, sep = ",",stringsAsFactors = FALSE))
...
#plot(output$Fitted,type="l")
#write.csv(output, file=paste("C:/Users/vangelis spil/Desktop/output.csv"),row.names=FALSE)
