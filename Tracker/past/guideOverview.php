    ...
    <div id="guideOverview">
          ...
          <div class="panel panel-defaut col-sm-3" <?php if(strpos($_SERVER['REQUEST_URI'],'city') !== false){ 
              ...
              <div class="panel-body">
                  <a href ="submissionOverview.php?view=city" <?php if(strpos($_SERVER['REQUEST_URI'],'city') !== false){ 
        ...
        <div class="col-sm-1"></div>
          <div class="panel panel-default col-sm-2" <?php if(strpos($_SERVER['REQUEST_URI'],'city') == false){ 
                                                    ...
                                                    ?>>
              <div class="panel-body">
                  <a href ="submissionOverview.php?view=administration" <?php if(strpos($_SERVER['REQUEST_URI'],'city') == false){ 
                                                        echo ' style=" color: white; "';
                                                     }
                                               ?> >Categories</a>
              </div>
